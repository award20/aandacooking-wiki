...
- **Freeform cooking**, where a valid but noncanonical combination can still produce a derived dish
...
This allows experimentation without requiring every possible ingredient combination to have a manually authored recipe.
