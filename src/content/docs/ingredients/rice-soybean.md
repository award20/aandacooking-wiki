...
The Soybean foundation includes:

- Soybean and Soybean Seeds
- Soybean Puree
- Soy Milk
- Sweet Soy Milk
- Fresh Tofu
...
| Soy Glazed Salmon | `salmon_glazed_soy_sauce` |
| Chicken Soy Fried Rice | `rice_fried_chicken_soy_sauce` |
| Beef Soy Fried Rice | `rice_fried_beef_soy_sauce` |
| Chicken Soy Noodle Stir Fry | `wheat_noodles_stir_fry_chicken_soy_sauce` |
| Beef Soy Noodle Stir Fry | `wheat_noodles_stir_fry_beef_soy_sauce` |
| Pickled Tofu Stir Fry | `soybean_tofu_stir_fry_pickled` |
| Soy Chicken Rice Bowl | `rice_bowl_chicken_soy_sauce` |
| Soy Salmon Rice Bowl | `rice_bowl_salmon_soy_sauce` |

These entries demonstrate why the ingredient catalog is organized as production chains rather than a flat item list: a single finished dish can depend on cooked Rice, prepared meat or fish, Soy Sauce, tofu, or a fermented prerequisite.
