...
Sweet Berry Jam is cooked in a [Saucepan](/cooking/saucepan/) from Sweet Berry Compote, [Powdered Sugar](/recipes/details/powdered-sugar/), and a Glass Jar. It is produced as a filled open jar and uses the Sugared preservation method. The jar can then be sealed at the [Jar Sealer](/stations/jar-sealer/) for an additional preservation effect.
