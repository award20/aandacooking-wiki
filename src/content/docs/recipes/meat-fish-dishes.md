...
## Baked and roasted proteins

The Oven provides another branch for meat and fish:

| Recipe ID | Dish | Time | Cooking condition |
|---|---|---:|---|
| `chicken_roasted` | Roasted Chicken | 45 seconds | Medium high oven |
...
| Recipe ID | Dish | Time | Cooking condition |
|---|---|---:|---|
| `chicken_breaded_crispy` | Crispy Breaded Chicken | 22 seconds | Medium high heat |
...
Sauces and condiments can become direct cooking inputs rather than only toppings.
...
- manual toss actions
- a minimum toss count
- prepared vegetables or mushrooms
...
Proteins also appear in larger recipe chains outside direct heat cooking. Examples include:
...
- Chicken and Salmon Rice Bowls
- Chicken and Beef Fried Rice
- Chicken and Beef noodle stir fries
- Creamy Herb Chicken Pasta
- Herb Chicken Tomato Pasta

These dishes are grouped on their respective catalog pages so this page can focus on protein centered cooking paths.

## Freshness

Raw meat and raw fish participate in the food freshness system. Raw fish has a shorter base freshness lifetime than raw meat, while completed dishes use the cooked dish freshness profile.

Refrigeration, freezing, fermentation, pickling, sugaring, and sealing can further affect spoilage where those preservation methods apply. See [Cold Storage](/storage/cold-storage/) and [Fermentation & Preservation](/recipes/fermentation-preservation/).
