...
The complete currently documented path table, including Tomato, Onion, Garlic, Egg, and Fresh Cheese transformations, is kept on [Ingredient Preparation](/getting-started/ingredient-preparation/).
...
The exact chain depends on the executable recipe requirement rather than a separate hand-written prerequisite list.
